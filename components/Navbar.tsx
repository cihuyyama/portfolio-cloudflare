                    ...
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <Link to="home">
                            <div className="container flex items-center space-x-2">
                                <h2 className="text-2xl text-black font-bold cursor-pointer">Muhammad Iqbal Al Habib</h2>
                            </div>
                        </Link>
                    ...
                    >
                        <div className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0 cursor-pointer">
                            ...
                            <a href="https://github.com/cihuyyama" rel="noreferrer" target="_blank">
                                <AiOutlineGithub
                                    className="md:mt-0 mt-5 hover:-translate-y-1 transition-transform cursor-pointer text-neutral-900"
                                    size={30}
                                />
                            </a>
                        </div>
